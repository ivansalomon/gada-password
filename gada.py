...
def modifyDic():
    ...
    if countListic > limit:
        ...
        print "\r\n      *************************************************"	
        print "      *                                               *"
        print "      *      Your dictionary have "+str(countListic)+" words           *"
        print "      *                                               *"
        print "      *************************************************\r\n"
    ...
    if conts == "y" and linije > limit:
        print "\r\n[-] Maximum number of words for concatenation is "+str(limit)
...
if len(sys.argv) < 2 or sys.argv[1] == '-h' or sys.argv[1] == '--hlp':
	
	print "	[ Options ]\r\n"
	print "	-h	--help"
	print "		   Default configuration file is gada.cfg\n"	

	print "	-i	 Interactive configuration\r\n"
